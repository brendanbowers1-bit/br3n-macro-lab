...
**1. Regimes matter.**  
Spot returns and strategy P&L differ by regime. Most `flat_range` P&L sits in **R2 (trend + low vol)** (~1.59 bps/day in sample).
...
- Full frictions cut 20y return from ~28.9% to ~2.43%  
- White Reality Check p = 0.628 → **does not** confirm data-mined alpha

## Cross-pair
9 pairs tested. **59.3%** of OOS cells beat flat benchmark. Only **MXN + TRY** win all 3 splits.
