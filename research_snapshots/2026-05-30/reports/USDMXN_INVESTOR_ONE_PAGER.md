...
| Corridor roadmap | 25 corridors scored |
...
- **Primary strategy tested:** `buy_and_hold`
- **Best hedge governance policy (US long MXN):** `fully_hedged`
...
*Generated 2026-05-30 · Refresh via `python scripts/generate_flagship_memo.py`*
